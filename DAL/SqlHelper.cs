...
namespace DAL
{
...

    {
        ...
        public static DataTable  Adapter(SqlConnection connection, CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
            SqlCommand cmd = new SqlCommand();
            ...
            {
                adapter.Fill(dt);//实现了从数据中读取数据并加载到DataTable中
            }
            return dt;
        ...
        public static int ExecuteNonQuery(SqlConnection connection, CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
            SqlCommand cmd = new SqlCommand();
            PrepareCommand(cmd, connection, null, cmdType, cmdText, commandParameters);
            cmd.CommandTimeout = 100000;   //要加这一句
            int val = cmd.ExecuteNonQuery();
            cmd.Parameters.Clear();
            return val;
        }
